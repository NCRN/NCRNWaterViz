...
BoxPlotMultipleOut<-reactive({
  ...
  summary_table <- summary_table %>% dplyr::mutate(
      ...
      ,Q1 = ifelse(Q1 == 'Data not collected', NA, Q1)
      ,Mean = ifelse(Mean == 'Data not collected', NA, Mean)
      ,Median = ifelse(Median == 'Data not collected', NA, Median)
      ,Q3 = ifelse(Q3 == 'Data not collected', NA, Q3)
...
#### USGS Functions ####
 ...
 #### NPS Data ####
  ...
  #Label directions
  directions <- c("top", "bottom", "left", "right") #, "tr", "tl", "br", "bl", "center") #additional label directions if needed
  offset <- list(
    top = c(0, -19),
    bottom = c(0, 19),
    left = c(-19, 0),
  ...
  observe({
    ...
    merge_data <- merge_data %>% mutate(SiteName = case_when(
