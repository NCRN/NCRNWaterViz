...
#### USGS Functions ####
 ...
 #### NPS Data ####
  ...
  output$WaterMap<-renderLeaflet({ 
    ...
    addTiles(group="Map", urlTemplate=NPSbasic,attribution=NPSAttrib, options=tileOptions(minZoom=netzoom)) %>% 
    addTiles(group="Imagery", urlTemplate=NPSimagery,attribution=NPSAttrib, options=tileOptions(minZoom=netzoom)) %>%
    addTiles(group="Light", urlTemplate=NPSlight,attribution=NPSAttrib, options=tileOptions(minZoom=netzoom)) %>%
    addTiles(group="Slate", urlTemplate=NPSslate, attribution=NPSAttrib, options=tileOptions(minZoom=netzoom) ) %>% 
